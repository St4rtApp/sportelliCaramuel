...
<html>
    ...
    <body style="background-image: url('IMGs/study.jpg')"class="overflow-hidden">
        ...
        <div id="form_container" class="mx-auto relative sm:top-40 shadow-lg pt-6 pb-10 bg-white rounded page-centered">
            <h1 id="titolo" class="text-center sm:text-xl text-2xl">Registrati</h1>
            <div class="pt-8">
                <form method="POST" id="login_form" class="mx-10">
                    <div class="relative flex w-full flex-wrap items-stretch mb-3">
                        ...
                        <input required name="email" id="email" type="text" placeholder="mail@esempio.com" class="px-2 sm:py-3 py-4 sm:text-base text-2xl placeholder-gray-400 text-gray-600 relative bg-white bg-white text-md border-b-3 sm:border-b-2 border-gray-400 w-full pl-10"/>
                    </div>
                    ...
                    <div class="relative flex w-full flex-wrap items-stretch mb-3">
                        ...
                        <input required name="nome" id="nome" type="text" placeholder="Nome" class=" px-2 py-3 placeholder-gray-400 text-gray-600 relative bg-white bg-white sm:text-base text-2xl border-b-3 sm:border-b-2 border-gray-400 w-full pl-10"/>
                    </div>
                    ...
                    <div class="relative flex w-full flex-wrap items-stretch mb-3">
                        ...
                        <select required name="anno" id="anno" type="text" class=" px-2 py-3 text-gray-400 relative bg-white bg-white sm:text-base text-2xl border-b-3 sm:border-b-2 border-gray-400 w-full pl-10">
                    ...
                    <div class="relative flex w-full flex-wrap items-stretch mb-3">
                        ...
                        <select required name="corso" id="corso" type="text" class=" px-2 py-3 text-gray-400 relative bg-white bg-white sm:text-base text-2xl border-b-3 sm:border-b-2 border-gray-400 w-full pl-10">
