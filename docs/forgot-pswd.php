<!-- pagina che richiede la mail dove si ha dimenticato la password e fa una POST a 'forgot-pswd'  -->
...
<html>
    ...
    <body style="background-image: url('IMGs/study.jpg'); background-size: cover;"class="overflow-hidden">
        ...
        <div id="form_container" class="mx-auto relative sm:top-40 shadow-lg pt-6 pb-10 bg-white rounded page-centered">
            <h1 id="titolo" class="text-center sm:text-xl text-2xl">Recupero password</h1>
            <div class="pt-8">
                <form method="POST" id="login_form" class="mx-10">
                    ...
                    <div class="relative flex w-full flex-wrap items-stretch mb-3">
                        ...
                        <input name="email" id="email" type="text" placeholder="mail@esempio.com" class="px-2 sm:py-3 py-4 sm:text-base text-2xl placeholder-gray-400 text-gray-600 relative bg-white bg-white text-md border-b-3 sm:border-b-2 border-gray-400 w-full pl-10"/>
                    </div>

                    <div class="sm:pt-4 pt-12">
                        <input id="submit_btn" name="forgot-pswd" value="forgot-pswd" type="submit" class="cursor-pointer bg-gradient-to-r from-green-400 to-blue-500 text-white font-bold uppercase sm:text-sm text-lg sm:px-4 px-7 sm:py-1 py-2 sm:rounded-full rounded-lg shadow hover:shadow-md hover:bg-blue-800 outline-none focus:outline-none ease-linear transition-all duration-150">
